...
from .image_parts.aggregation import BoreholeAggregationMixin
from .image_parts.vision import OpenAICompatibleVisionClient, VisionClient
...
class BoreholeImageRecognizer(BoreholeAggregationMixin):
    """渲染并识别 PDF 中的钻孔柱状图。"""
